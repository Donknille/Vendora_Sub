...
const translations = {
  en: {
    ...
    auth: {
      locked: "Vendora Locked",
      subtitle: "Please authenticate to access your business data.",
      unlock: "Unlock",
      notSupported: "Biometrics not supported or enrolled on this device.",
    },
  ...
  de: {
    ...
    auth: {
      locked: "Vendora Gesperrt",
      subtitle: "Bitte authentifizieren Sie sich, um auf Ihre Geschäftsdaten zuzugreifen.",
      unlock: "Entsperren",
      notSupported: "Biometrie wird auf diesem Gerät nicht unterstützt.",
    },
