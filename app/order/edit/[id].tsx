...
export default function EditOrderScreen() {
    ...
    const loadOrder = async () => {
        ...
        if (order) {
            ...
            setOrderDate(order.orderDate || order.createdAt.split('T')[0]);
            setServiceDate(order.serviceDate || (order.orderDate || order.createdAt.split('T')[0]));
            setShippingCost(order.shippingCost ? order.shippingCost.toString().replace('.', ',') : "");
